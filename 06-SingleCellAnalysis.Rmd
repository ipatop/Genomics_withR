...
```{r include=FALSE}
load("../SingleCell/sc_class.RData")
```
...
sc.small <- matrix(c(0,43,22,92,0,21,68,22,9,10,54,36,0,0,0),ncol=4,byrow=TRUE)
colnames(sc.small) <- c("cell1","cell2","cell3","...")
rownames(sc.small) <- c("genA","genB","genC","...")
sc.small <- as.data.frame(sc.small)
```
...
```{r, out.width = "500px", echo=FALSE,fig.align = "center",fig.cap="Why we should do quality filtering to the data. Origin unknown."}
knitr::include_graphics("./SingleCell_2/poop.png")
```
...
```{r, warning=FALSE, message=FALSE, fig.cap="Variable genes plot"}
...
```{r, out.width = "500px", echo=FALSE,fig.align = "center",fig.cap="Figure from: Comprehensive Integration of Single-Cell Data, Stuart et al. Cell 2019"}
knitr::include_graphics("./SingleCell_2/seurat.jpg")
```
...
```{r, warning=FALSE, message=FALSE, fig.cap="Number of Genes and Number of UMIs"}
...
```{r, warning=FALSE, message=FALSE,fig.cap="PCA plots"}
...
```{r, warning=FALSE, message=FALSE,fig.cap="PCA heatmap plots"}
...
```{r, warning=FALSE, message=FALSE, fig.cap="UMAP plot"}
...
```{r, warning=FALSE, message=FALSE,fig.height=20,fig.width=10, fig.cap="Heatmap of marker genes per cluster"}
...
```{r, out.width = "500px", echo=FALSE, , fig.align="center",fig.cap="A Sunday Afternoon on the Island of La Grande Jatte or Un dimanche après-midi à l'Île de la Grande Jatte, Georges Seurat, Oil on canvas, 1884–1886 "}
knitr::include_graphics("./SingleCell_2/seuratpic.jpg")
```
