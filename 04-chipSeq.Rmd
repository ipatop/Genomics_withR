...
```{r, out.width = "500px", echo=FALSE, fig.align="center",fig.cap="Circadian clock at the molecular level. Figure adapted from Meireles-Filho  et al 2013"}
#knitr::include_graphics("../macs2_analysis_p0.05/clkcyc.jpg")
```
...
We will study RNA oscilations over the day in next chapter.
